...
export const Header = () => {
	return(
		<div>
			<header className="fixed top-0 left-0 w-full px-4 py-3 md:py-0 lg:px-6 z-15">
					...
					<div className="flex items-center">
						<div className="main-menu block z-20 fixed top-0 -right-full transition-all duration-300 overflow-y-scroll overflow-auto md:overflow-y-auto h-full w-[285px] bg-white md:bg-transparent mh:h-auto md:w-auto md:static">
							...
							<ul className="items-center font-lato font-normal text-sm text-dark py-4 md:py-0 md:text-white leading-none justify-end block md:flex">
	                            <li className="relative py-3 sm:p-0 active"><a href="#" className="border-l-[3px] md:border-l-0 md:border-b-[3px] block border-transparent py-4 md:py-8 px-6 md:px-4 hover:text-theme">Hotels</a></li>
	                            <li className="relative py-3 sm:p-0 md:ml-4 lg:ml-6"><a href="#" className="border-l-[3px] md:border-l-0 md:border-b-[3px] block border-transparent py-4 md:py-8 px-6 md:px-4 hover:text-theme">Listing </a></li>
	                            <li className="relative py-3 sm:p-0 md:ml-4 lg:ml-6"><a href="#" className="border-l-[3px] md:border-l-0 md:border-b-[3px] block border-transparent py-4 md:py-8 px-6 md:px-4 hover:text-theme">Agent</a></li>
	                            <li className="relative py-3 sm:p-0 md:ml-4 lg:ml-6"><a href="#" className="border-l-[3px] md:border-l-0 md:border-b-[3px] block border-transparent py-4 md:py-8 px-6 md:px-4 hover:text-theme">Pricing</a></li>
	                        </ul>
						</div>
