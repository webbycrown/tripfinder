...
export const Hero_section = () => {
	...
	const from_btn = 'Find Hotels';
     const heroImages = [
            {
              url: "/assets/img/hero-img1.jpg",
            },
            {
              url: "/assets/img/hero-img2.jpg",
            },
            {
              url: "/assets/img/hero-img3.jpg",
            },
          ];
	return(
            ...
            <section className="home-hiro-slider relative min-h-screen flex flex-wrap pt-14 pb-16 sm:pt-20 sm:pb-20">
                        ...
                        <div className="swiper-wrapper h-full">
                            {
                                heroImages &&
                                heroImages.length > 0 &&
                                heroImages.map((image, index1) => (
                                <React.Fragment key={image.url}>
                                <div className="swiper-slide h-full">
                                    <div className="px-3 bg-center h-full relative bg-no-repeat bg-center bg-cover py-28 text-center" style={{ backgroundImage: `url(${image.url})` }}>
                ...
                <div className="mx-auto container lg:max-w-[1170px] relative z-4 flex items-end">
            ...
            <div className="swiper-pagination mb-4 z-3"></div>
        </section>
