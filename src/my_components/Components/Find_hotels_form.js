            				...
            				<div className="relative w-full border-t border-gray-200 lg:border-transparent">
            					...
            					<div className="flex items-center justify-between quantity-room-wrap">
                                    ...
                                    <span>Room 
                                        ...
                                        <input type="hidden" className="guest-hidden" name="room" value="" />
                                    </span>
                                ...
                                <div className="popup_container popup_container_btns hidden absolute top-full left-0 min-w-[300px] bg-white p-5 shadow-popup rounded-[3px]">
                                    <div className="">
