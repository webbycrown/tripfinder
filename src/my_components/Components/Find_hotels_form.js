            			...
            			<div className="bg-gray-100 sm:mt-10 lg:flex items-center">
            				<div className="relative w-full">
            					...
            					<div className="w-full relative">
            						<input type="text" placeholder="Search “Thailand, Asia”" className="w-full bg-transparent text-dark h-[60px] text-sm pl-10 pr-8 ant-input ant-input-lg pac-target-input" autoComplete="off" />
            					</div>
                                    ...
                                    <div className="">
                                        <div className="flex items-center justify-between mb-6">
                                            ...
                                            <div className="quantity flex items-center justify-between w-[104px]">
                                                ...
                                                <input className="ant-input qnt-input text-center w-[50px] bg-white" type="number" id="room" value="0" />
